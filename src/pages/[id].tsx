...
const PollHome: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-row h-screen divide-x divide divide-slate-500 text-slate-500">
        <div className="p-2 basis-1/6 ">
          <p className="text-purple-300 opacity-50">Room key: {pollsByGroup.data?.key}</p>
        </div>
        <div className="p-2 basis-4/6 ">
          <Feed key={key} />
        </div>
        <div className="p-2 basis-1/6 ">
          <Settings />
...
const Feed: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 px-[20%]">
      <Link href="/" className="text-3xl font-bold text-center text-purple-300">
        Feed
      </Link>
      <div>
        <div className="flex flex-row justify-end gap-1">
          <button
            ...
            className="w-10 p-2 text-white rounded bg-slate-800 bg-gradient-to-r from-blue-800 to-purple-800 hover:from-blue-700 hover:to-purple-700"
          >
            -
          </button>
          <button
            ...
            className="w-10 p-2 text-white rounded bg-slate-800 bg-gradient-to-r from-purple-800 to-red-800 hover:from-purple-700 hover:to-red-700"
          >
            +
          </button>
        </div>
       {/*
        ...
        <form onSubmit={handleCreatePoll} className="flex flex-col gap-2 ">
          ...
          <div className="flex justify-center pt-2">
            <button
              type="submit"
              className="p-2 text-white rounded bg-slate-800 bg-gradient-to-r from-blue-700 to-purple-700 hover:from-blue-600 hover:to-purple-600"
            >
              Create poll
            </button>
          </div>
...
const Settings: React.FC = () => {
  return (
    <div className="flex flex-row justify-end gap-4 ">
      <button className="flex items-center justify-center w-16 h-16 text-center border border-gray-800 ">Logout</button>
      <button className="flex items-center justify-center w-16 h-16 text-center border border-gray-800 ">
        Profile
      </button>
    </div>
  );
